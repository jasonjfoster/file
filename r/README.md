...
First, load the package and explore the available form types, which are sourced from the SEC EDGAR form types data <https://www.sec.gov/Archives/edgar/lookup-data.js>:
